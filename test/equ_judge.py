...
if __name__ == "__main__":
    ...
    image = torch.tensor(
        [
            [1.0, 2.0, 3.0, 4.0, 99.0, 8],
            [5.0, 6.0, 7.0, 8.0, 99.0, 9],
            [9.0, 10.0, 11.0, 12.0, 77.0, 1],
            [13.0, 14.0, 15.0, 16.0, 8.0, 2],
            [17.0, 18.0, 19.0, 20.0, 44.0, 3],
            [21.0, 22.0, 23.0, 24.0, 55.0, 4],
        ]
    )
    # kernel = torch.tensor([
    #     [1., 3., 9., 10.],
    ...
    v = (
        torch.nn.functional.interpolate(
            (H @ flat_image).reshape(6, 6)[::2, ::2].unsqueeze(0).unsqueeze(0),
            scale_factor=2,
            mode="nearest",
        )
        .squeeze()
